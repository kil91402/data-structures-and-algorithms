...
const raisedToTheThird = (arr) => {
  ...
  arr.forEach((num) => {
    const raisedNum = Math.pow(num, 3);
    result.push(raisedNum);
  });
...
------------------------------------------------------------------------------------------------ */
let arr3 = ["What", "When", "Where", "How"]
const addQuestion = (arr3) => {
  // Solution code here...
  return arr3.map((str) => str + "?");
};
...
------------------------------------------------------------------------------------------------ */
let arr4 = [7, 8, 9]
const forLoopTwoToThe = (arr4) => {
  // Solution code here...
  const result = [];

  for (let i = 0; i < arr4.length; i++) {
    const power = Math.pow(2, arr4[i]);
    result.push(power);
  }
...
------------------------------------------------------------------------------------------------ */
let arr6 = [7, 8, 9]
const mapTwoToThe = (arr6) => {
  // Solution code here...
  return arr6.map((num) => Math.pow(2, num));
};
